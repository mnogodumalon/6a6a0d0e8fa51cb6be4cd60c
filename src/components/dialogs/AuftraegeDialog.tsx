...
export function AuftraegeDialog({ open, onClose, onSubmit, defaultValues, recordId, kundenList, enablePhotoScan = true, enablePhotoLocation = true }: AuftraegeDialogProps) {
  ...
  const REQUIRED_FIELDS = ['auftragsnummer', 'bezeichnung', 'kunde', 'auftragsdatum', 'status'] as const;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'bezeichnung': (
      <div key="bezeichnung" className="space-y-1.5">
        <Label htmlFor="bezeichnung">Auftragsbezeichnung <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="bezeichnung"
          placeholder="z. B. Heizungsinstallation OG"
    ...
    'ansprechpartner': (
      <div key="ansprechpartner" className="space-y-1.5">
        <Label htmlFor="ansprechpartner">Ansprechpartner beim Kunden</Label>
        <Input
          id="ansprechpartner"
    ...
    'auftragsdatum': (
      <div key="auftragsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="auftragsdatum"
          placeholder="Wann liegt die Bestellung vor?"
          mode="date"
    ...
    'fertigstellungsdatum': (
      <div key="fertigstellungsdatum" className="space-y-1.5">
        <Label htmlFor="fertigstellungsdatum">Gewünschtes Fertigstellungsdatum</Label>
        <DatePicker
          id="fertigstellungsdatum"
          placeholder="Gewünschter Abschluss?"
          mode="date"
          value={fields.fertigstellungsdatum ?? null}
          onChange={v => setFields(f => ({ ...f, fertigstellungsdatum: v ?? undefined }))}
        />
      </div>
    ),
    'status': (
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Arbeitsschritte, Anforderungen, besondere Hinweise..."
    ...
    'bemerkungen_auftrag': (
      <div key="bemerkungen_auftrag" className="space-y-1.5">
        <Label htmlFor="bemerkungen_auftrag">Bemerkungen</Label>
        <Textarea
          id="bemerkungen_auftrag"
          placeholder="Kundenanforderungen, Besonderheiten, Rechnungsmodal..."
  ...
  const APPLOOKUP_LABELS: Record<string, Record<string, string>> = {"kunde": {"vorname": "Vorname", "nachname": "Nachname", "firma": "Firma", "strasse": "Straße", "hausnummer": "Hausnummer", "plz": "Postleitzahl", "ort": "Ort", "telefon": "Telefon", "email": "E-Mail", "bemerkungen_kunde": "Bemerkungen"}};
