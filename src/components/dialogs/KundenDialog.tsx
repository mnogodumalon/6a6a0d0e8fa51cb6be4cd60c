...
export function KundenDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: KundenDialogProps) {
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'firma': (
      <div key="firma" className="space-y-1.5">
        ...
        <Input
          id="firma"
          placeholder="z. B. Handelskonzern GmbH"
          value={fields.firma ?? ''}
    ...
    'bemerkungen_kunde': (
      <div key="bemerkungen_kunde" className="space-y-1.5">
        <Label htmlFor="bemerkungen_kunde">Bemerkungen</Label>
        <Textarea
          id="bemerkungen_kunde"
          placeholder="Besondere Wünsche, Zahlungsbedingungen, Kontaktregeln..."
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "firma": "Firma", "strasse": "Straße", "hausnummer": "Hausnummer", "plz": "Postleitzahl", "ort": "Ort", "telefon": "Telefon", "email": "E-Mail", "bemerkungen_kunde": "Bemerkungen"};
