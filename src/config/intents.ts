...
// <custom:intent-imports>
import { IconClipboardPlus, IconFileCheck } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/pruefprotokoll-erstellen', label: 'Prüfprotokoll', icon: IconFileCheck, description: 'Prüfprotokoll für Auftrag erstellen' },
  // </custom:intents>
];
